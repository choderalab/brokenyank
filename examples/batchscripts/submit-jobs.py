...
mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python $YANKDIR/yank.py --receptor_prmtop receptor.prmtop --ligand_prmtop ligand.prmtop --complex_crd complex.crd --output . --mpi --restraints flat-bottom --iterations 2000

# Harmonic restraint
#mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python $YANKDIR/yank.py --receptor_prmtop receptor.prmtop --ligand_prmtop ligand.prmtop --complex_crd complex.crd --output . --mpi --verbose

# Flat-bottom restraints, specifying AMBER .crd.
#mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python $YANKDIR/yank.py --complex_prmtop complex.prmtop  --receptor_prmtop receptor.prmtop --ligand_prmtop ligand.prmtop --complex_crd complex.crd --output . --mpi --restraints flat-bottom --verbose

# Harmonic restraints
#mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python $YANKDIR/yank.py --complex_prmtop complex.prmtop --receptor_prmtop receptor.prmtop --ligand_prmtop ligand.prmtop --complex_crd complex.crd --output . --mpi --randomize_ligand --verbose

# Flat-bottom restraints, specifying PDB.
#mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python $YANKDIR/yank.py --complex_prmtop complex.prmtop  --receptor_prmtop receptor.prmtop --ligand_prmtop ligand.prmtop --complex_pdb complex.pdb --output . --mpi --restraints flat-bottom --verbose

#mpirun_rsh -ssh -np ${NP} -hostfile ${PBS_NODEFILE} python yank.py --complex_prmtop $JOBDIR/complex.prmtop  --receptor_prmtop $JOBDIR/receptor.prmtop --ligand_prmtop $JOBDIR/ligand.prmtop --complex_crd $JOBDIR/complex.crd --output $JOBDIR --mpi --restraints flat-bottom --verbose --iterations 100
